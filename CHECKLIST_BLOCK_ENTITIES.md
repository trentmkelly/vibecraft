...
- [ ] Implement `BlockEntity.changed()` marking the containing chunk as dirty for save: `BlockEntity::set_changed()` sets `changed` only after `set_level()`, covered by `changed_flag_only_sets_when_attached_to_level`
