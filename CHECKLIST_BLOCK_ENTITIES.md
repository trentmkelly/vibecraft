...
- [ ] Implement `BlockEntity.clearRemoved()` / `setRemoved()` lifecycle hooks: `set_removed()` and `clear_removed()` update the removal flag, and ticking refuses removed block entities
