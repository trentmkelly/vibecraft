...
pub enum CommandError {
    ...
    TeamNameUnchanged,
    TeamColorUnchanged,
    TeamFriendlyFireAlreadyEnabled,
    TeamFriendlyFireAlreadyDisabled,
    TeamFriendlyInvisiblesAlreadyEnabled,
    TeamFriendlyInvisiblesAlreadyDisabled,
    TeamNametagVisibilityUnchanged,
    TeamDeathMessageVisibilityUnchanged,
    TeamCollisionRuleUnchanged,
    SetBlockFailed,
    FunctionNoFunctions,
