...
pub const CHUNK_STATUS_PIPELINE: &[ChunkStatusEntry] = &[
    ChunkStatusEntry {
        id: "minecraft:empty",
        parent: "minecraft:empty",
        index: 0,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: WORLDGEN_HEIGHTMAPS,
        task: ChunkStatusTaskKind::PassThrough,
        region_dependencies: 0,
        requirements: NO_REQUIREMENTS,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:structure_starts",
        parent: "minecraft:empty",
        index: 1,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: WORLDGEN_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateStructureStarts,
        region_dependencies: 0,
        requirements: NO_REQUIREMENTS,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:structure_references",
        parent: "minecraft:structure_starts",
        index: 2,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: WORLDGEN_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateStructureReferences,
        region_dependencies: 8,
        requirements: STRUCTURE_STARTS_DISTANCE_8_REQUIREMENT,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:biomes",
        parent: "minecraft:structure_references",
        index: 3,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: WORLDGEN_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateBiomes,
        region_dependencies: 8,
        requirements: STRUCTURE_STARTS_DISTANCE_8_REQUIREMENT,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:noise",
        parent: "minecraft:biomes",
        index: 4,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: WORLDGEN_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateNoise,
        region_dependencies: 8,
        requirements: STRUCTURE_STARTS_DISTANCE_8_AND_BIOMES_DISTANCE_1_REQUIREMENTS,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:surface",
        parent: "minecraft:noise",
        index: 5,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: WORLDGEN_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateSurface,
        region_dependencies: 8,
        requirements: STRUCTURE_STARTS_DISTANCE_8_AND_BIOMES_DISTANCE_1_REQUIREMENTS,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:carvers",
        parent: "minecraft:surface",
        index: 6,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: FINAL_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateCarvers,
        region_dependencies: 8,
        requirements: STRUCTURE_STARTS_DISTANCE_8_REQUIREMENT,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:features",
        parent: "minecraft:carvers",
        index: 7,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: FINAL_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateFeatures,
        region_dependencies: 8,
        requirements: STRUCTURE_STARTS_DISTANCE_8_AND_CARVERS_DISTANCE_1_REQUIREMENTS,
        block_state_write_radius: 1,
    },
    ChunkStatusEntry {
        id: "minecraft:initialize_light",
        parent: "minecraft:features",
        index: 8,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: FINAL_HEIGHTMAPS,
        task: ChunkStatusTaskKind::InitializeLight,
        region_dependencies: 1,
        requirements: NO_REQUIREMENTS,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:light",
        parent: "minecraft:initialize_light",
        index: 9,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: FINAL_HEIGHTMAPS,
        task: ChunkStatusTaskKind::Light,
        region_dependencies: 1,
        requirements: INITIALIZE_LIGHT_DISTANCE_1_REQUIREMENT,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:spawn",
        parent: "minecraft:light",
        index: 10,
        chunk_type: ChunkType::ProtoChunk,
        heightmaps_after: FINAL_HEIGHTMAPS,
        task: ChunkStatusTaskKind::GenerateSpawn,
        region_dependencies: 1,
        requirements: BIOMES_DISTANCE_1_REQUIREMENT,
        block_state_write_radius: 0,
    },
    ChunkStatusEntry {
        id: "minecraft:full",
        parent: "minecraft:spawn",
        index: 11,
        chunk_type: ChunkType::LevelChunk,
        heightmaps_after: FINAL_HEIGHTMAPS,
        task: ChunkStatusTaskKind::Full,
        region_dependencies: 0,
        requirements: NO_REQUIREMENTS,
        block_state_write_radius: 0,
    },
