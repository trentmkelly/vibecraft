...
pub const PLAY_PACKET_SPECS_26_1_2: &[PlayPacketSpec] = &[
    ...
    sb!(59, "set_structure_block", "ServerboundSetStructureBlockPacket", "pos:BlockPos, update_type:enum VarInt, mode:StructureMode enum VarInt, name:utf8, offset:3 i8 clamped -48..48, size:3 i8 clamped 0..48, mirror:enum VarInt, rotation:enum VarInt wrap, data:utf8 max 128, integrity:f32 clamped 0..1, seed:VarLong, flags:u8(ignore_entities=1, show_air=2, show_bounding_box=4, strict=8)"),
    ...
    cb!(26, "debug_block_value", "ClientboundDebugBlockValuePacket", "block_pos:BlockPos, update:DebugSubscription.Update"),
    cb!(27, "debug_chunk_value", "ClientboundDebugChunkValuePacket", "chunk_pos:ChunkPos i64, update:DebugSubscription.Update"),
    cb!(28, "debug_entity_value", "ClientboundDebugEntityValuePacket", "entity_id:VarInt, update:DebugSubscription.Update"),
    cb!(29, "debug_event", "ClientboundDebugEventPacket", "event:DebugSubscription.Event"),
