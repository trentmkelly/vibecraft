...
mod tests {
    ...
    fn cookie_packet_types_and_listener_surfaces_match_java() {
        ...
        const SERVER_COOKIE_LISTENER_JAVA: &str = vibecraft_java_source!("/net/minecraft/network/protocol/cookie/ServerCookiePacketListener.java");
        for sentinel in [
        ...
        const COOKIE_PACKET_TYPES_JAVA: &str = vibecraft_java_source!("/net/minecraft/network/protocol/cookie/CookiePacketTypes.java");
        for sentinel in [
