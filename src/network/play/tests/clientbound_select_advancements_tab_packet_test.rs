...
const CLIENTBOUND_SELECT_ADVANCEMENTS_TAB_JAVA: &str = vibecraft_java_source!("/net/minecraft/network/protocol/game/ClientboundSelectAdvancementsTabPacket.java");
