...
const CLIENTBOUND_PLAYER_COMBAT_END_JAVA: &str = include_str!(
    "../../../../../decompiled-server-26.1.2/net/minecraft/network/protocol/game/ClientboundPlayerCombatEndPacket.java"
);
const CLIENTBOUND_PLAYER_COMBAT_ENTER_JAVA: &str = include_str!(
    "../../../../../decompiled-server-26.1.2/net/minecraft/network/protocol/game/ClientboundPlayerCombatEnterPacket.java"
);
const CLIENTBOUND_PLAYER_COMBAT_KILL_JAVA: &str = include_str!(
    "../../../../../decompiled-server-26.1.2/net/minecraft/network/protocol/game/ClientboundPlayerCombatKillPacket.java"
);
