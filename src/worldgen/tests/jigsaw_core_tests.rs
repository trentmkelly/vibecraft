use super::*;
    ...
    fn jigsaw_connector_orientation_and_attachment_match_vanilla_can_attach() {
        ...
        assert_eq!(super::super::JigsawDirectionModel::from_id("north"), Some(North));
        assert_eq!(super::super::JigsawDirectionModel::from_id("sideways"), None);
        ...
        assert!(!super::super::jigsaw_connectors_can_attach(&source, &wrong_front));

        let wrong_top = super::super::JigsawConnectorModel {
            top: East,
            ..matching_target
        };
        assert!(!super::super::jigsaw_connectors_can_attach(&source, &wrong_top));
        ...
        assert!(!super::super::jigsaw_connectors_can_attach(&source, &wrong_name));
    }
    ...
    fn jigsaw_pool_element_surfaces_match_vanilla_registry_and_pool_rules() {
        assert_eq!(
            super::super::JigsawPoolElementTypeModel::REGISTRY_ORDER.map(|element_type| element_type.id()),
            [
        ...
        let single = super::super::JigsawPoolElementModel::single(
        ...
        let legacy = super::super::JigsawPoolElementModel::legacy_single(
        ...
        let feature = super::super::JigsawPoolElementModel::feature(
        ...
        let list = super::super::JigsawPoolElementModel::list(
        ...
        assert_eq!(
            super::super::JigsawPoolElementModel::list(Vec::new(), super::super::JigsawProjectionModel::Rigid),
            Err("Elements are empty".to_string())
        );

        let pool = super::super::JigsawTemplatePoolModel::new(
            "minecraft:empty",
            vec![
    ...
    fn jigsaw_pool_availability_decision_matches_java_warning_and_skip_rules() {
        ...
        assert_eq!(
            super::super::jigsaw_pool_availability_decision(true, 3, "minecraft:village/bad_fallback", 0),
            super::super::JigsawPoolAvailabilityDecisionModel {
                can_place_children: false,
    ...
    fn jigsaw_structure_start_pools_match_java_bootstrap_start_keys() {
        ...
        assert!(super::super::JIGSAW_STRUCTURE_START_POOLS.iter().any(|entry| {
