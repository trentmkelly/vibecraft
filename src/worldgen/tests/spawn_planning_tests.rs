use super::*;
    ...
    fn climate_spawn_position_uses_vanilla_two_pass_radial_search() {
        ...
        let router = super::super::builtin_noise_router("overworld").unwrap().router;
    ...
    fn chunk_generation_mob_top_non_colliding_pos_uses_spawn_heightmap() {
        ...
        let plan =
            super::super::chunk_generation_mob_top_non_colliding_pos(&chunk, "minecraft:pig", x, z, false);
    ...
    fn chunk_generation_spawn_position_ok_matches_placement_type_primitives() {
        ...
        assert_eq!(super::super::spawn_placement_type("minecraft:squid"), "in_water");
        assert_eq!(super::super::spawn_placement_type("minecraft:strider"), "in_lava");
        assert_eq!(
    ...
    fn chunk_generation_mob_collision_plan_rejects_solid_blocks_inside_spawn_aabb() {
        ...
        assert!(super::super::chunk_generation_mob_no_collision(&chunk, collision));
