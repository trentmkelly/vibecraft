...
pub(super) fn assert_disk_dripstone_and_large_dripstone_support() {
    assert_disk_support();
    assert_snow_and_freeze_support();
    assert_underwater_magma_support();
    assert_dripstone_cluster_math_support();
    assert_dripstone_cluster_column_support();
    assert_pointed_dripstone_support();
    assert_large_dripstone_support();
}

fn assert_disk_support() {
...
fn assert_snow_and_freeze_support() {
...
fn assert_underwater_magma_support() {
...
fn sample_dripstone_cluster_config() -> super::super::DripstoneClusterSampledConfig {
    super::super::DripstoneClusterSampledConfig {
...
fn assert_dripstone_cluster_math_support() {
    let dripstone_config = sample_dripstone_cluster_config();
    assert_eq!(
        super::super::validate_dripstone_cluster_sampled_config(dripstone_config),
        Ok(dripstone_config)
    );
    assert!(
        (super::super::dripstone_cluster_chance_of_column(3, 3, 3, 0, dripstone_config) - 0.2)
            .abs()
            < 0.000001
    );
    assert_eq!(
    ...
    assert_eq!(
        super::super::dripstone_cluster_height_for_column(
            1,
            1,
            0.5,
            6,
...
fn assert_dripstone_cluster_column_support() {
    let dripstone_config = sample_dripstone_cluster_config();
...
fn assert_pointed_dripstone_support() {
    ...
    let pointed_plan =
        super::super::pointed_dripstone_feature_plan(super::super::PointedDripstoneFeatureInput {
...
fn assert_large_dripstone_support() {
