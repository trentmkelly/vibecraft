use super::*;
    ...
    fn biome_generation_settings_plains_matches_registry_payload() {
        ...
        assert!(super::super::biome_has_placed_feature(plains, "trees_plains"));
        assert!(super::super::biome_has_placed_feature(
            plains,
            "minecraft:ore_diamond_buried"
        ));
        assert!(!super::super::biome_has_placed_feature(plains, "trees_jungle"));
        assert_eq!(
    ...
    fn the_void_biome_generation_settings_match_json_contract() {
        ...
        assert_eq!(super::super::biome_spawns_for_category(the_void, "monster"), &[]);
    }
