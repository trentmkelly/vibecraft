use super::*;
    ...
    fn mineshaft_start_materials_and_piece_boxes_match_vanilla() {
        ...
        assert_eq!(super::super::mineshaft_type_id(super::super::MineshaftTypeModel::Mesa), 1);
        assert_eq!(
        ...
        assert_eq!(
            super::super::mineshaft_find_crossing(10, 40, -5, super::super::HorizontalDirection::East, 0, &[],)
                .unwrap(),
            Some(super::super::StructureBoundingBoxModel {
                min_x: 10,
                min_y: 40,
        ...
        assert_eq!(
            super::super::mineshaft_find_stairs(10, 40, -5, super::super::HorizontalDirection::West, &[],),
            Some(super::super::StructureBoundingBoxModel {
                min_x: 2,
                min_y: 35,
                min_z: -5,
    ...
    fn stronghold_start_weights_and_portal_room_match_vanilla() {
        ...
        assert!(super::super::stronghold_has_limited_piece_available(&weights));
        assert!(!super::super::stronghold_piece_weight_can_place(weights[9], 4));
        assert!(super::super::stronghold_piece_weight_can_place(weights[9], 5));
        ...
        assert!(!super::super::stronghold_piece_weight_is_valid(exhausted_portal));
        ...
        let start = super::super::stronghold_start_piece(ChunkPos { x: -2, z: 3 }, 1).unwrap();
        ...
        let portal_room =
            super::super::stronghold_portal_room(10, 40, -5, super::super::HorizontalDirection::South, 7, &[])
                .unwrap();
        assert_eq!(
        ...
        assert_eq!(portal_room.orientation, super::super::HorizontalDirection::South);
        ...
        let west_portal =
            super::super::stronghold_portal_room(10, 40, -5, super::super::HorizontalDirection::West, 7, &[])
                .unwrap();
        assert_eq!(
        ...
        assert_eq!(
            super::super::stronghold_portal_room(10, 10, -5, super::super::HorizontalDirection::South, 7, &[]),
            None
        );
        assert_eq!(
    ...
    fn nether_fortress_start_weights_and_child_anchors_match_vanilla() {
        ...
        let castle_weights =
            super::super::nether_fortress_piece_weights(super::super::NetherFortressPiecePoolModel::Castle);
        ...
        let start = super::super::nether_fortress_start_piece(ChunkPos { x: -2, z: 3 }, 0).unwrap();
        ...
        let crossing_box = super::super::nether_fortress_bridge_crossing_box(
            10,
            40,
            -5,
            super::super::HorizontalDirection::South,
