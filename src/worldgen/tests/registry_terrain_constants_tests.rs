use super::*;
    ...
    fn terrain_blending_and_upgrade_data_match_vanilla_constants() {
        ...
        assert_eq!(super::super::BELOW_ZERO_RETROGEN_MODEL.max_generated_bedrock_y, 4);
        assert_eq!(
        ...
        assert_eq!(super::super::below_zero_missing_bedrock_bit_index(17, 18), 33);
        let missing_bedrock = [1_u64 << 33];
        assert!(super::super::below_zero_has_bedrock_hole(&missing_bedrock, 1, 2));
        assert!(!super::super::below_zero_has_bedrock_hole(&missing_bedrock, 2, 2));
        assert_eq!(
