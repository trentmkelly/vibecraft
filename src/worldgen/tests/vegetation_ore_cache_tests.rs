...
fn final_client_heightmaps_are_computed_from_blocks() {
    ...
    let Tag::LongArray(motion_blocking) = chunk.heightmaps.get("MOTION_BLOCKING").unwrap() else {
...
fn configured_simple_vegetation_places_single_and_double_plants() {
    ...
    let mut random =
        super::super::RandomSourceKind::new(1, super::super::RandomAlgorithm::Xoroshiro);
    assert_eq!(
    ...
    let mut random =
        super::super::RandomSourceKind::new(2, super::super::RandomAlgorithm::Xoroshiro);
    assert_eq!(
        super::super::place_configured_simple_vegetation_in_target_chunk(
            &mut chunk,
            settings,
...
fn ore_block_cache_uses_world_coordinates_without_chunk_wrapping() {
    ...
    let mut block_states = PalettedContainer::single(
        super::super::block_state_tag("minecraft:stone"),
        SECTION_VOLUME,
    );
    block_states.set_entry(
