use super::*;
    ...
    fn desert_pyramid_archaeology_state_matches_after_place_rules() {
        let mut piece = super::super::desert_pyramid_generation_piece(
            ChunkPos { x: 1, z: -1 },
    ...
    fn jungle_temple_piece_container_flags_match_vanilla() {
        let piece = super::super::jungle_temple_generation_piece(
            ChunkPos { x: 0, z: 0 },
            super::super::HorizontalDirection::South,
        );
    ...
    fn igloo_template_piece_generation_and_surface_shift_match_vanilla() {
        let pieces = super::super::igloo_generation_pieces(
            ChunkPos { x: 2, z: -3 },
        ...
        assert_eq!(no_basement[0].template, super::super::IglooTemplateKind::Top);
    ...
    fn ruined_portal_setup_template_and_vertical_rules_match_vanilla() {
        let land_setup = super::super::RuinedPortalSetupModel {
        ...
        let nether_setup = super::super::RuinedPortalSetupModel {
        ...
        let properties = super::super::ruined_portal_make_properties(nether_setup, 0.0, true).unwrap();
        assert_eq!(
            properties,
    ...
    fn shipwreck_template_height_and_loot_rules_match_vanilla() {
        ...
        let piece = super::super::shipwreck_make_piece(
            ChunkPos { x: -1, z: 4 },
            super::super::StructureRotation::Clockwise180,
            7,
            false,
        ...
        assert!(!super::super::shipwreck_is_too_big_to_fit_in_worldgen_region(
            BlockPos {
                x: 32,
                y: 32,
                z: 80
        ...
        assert_eq!(super::super::shipwreck_loot_table_for_marker("unknown"), None);
    }
    ...
    fn ocean_ruin_piece_templates_markers_and_height_match_vanilla() {
        ...
        let warm_config = super::super::OceanRuinStructureConfigModel {
        ...
        let cold_config = super::super::OceanRuinStructureConfigModel {
