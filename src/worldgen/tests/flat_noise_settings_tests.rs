...
fn overworld_base_3d_noise_matches_vanilla_in_river_column() {
    ...
    let base_3d = super::super::BASE_3D_NOISE_OVERWORLD_DENSITY
        .compute_with_noise(seed, settings, -16, 56, -8);
    assert!(
...
fn overworld_climate_sampler_and_rtree_agree_at_seed_0_block_0_64_0() {
    ...
    let list =
        ClimateParameterList::new(params.to_vec()).expect("overworld parameter list is non-empty");
