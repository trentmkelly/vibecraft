use super::*;
    ...
    fn ocean_monument_generation_point_and_room_primitives_match_vanilla() {
        ...
        assert_eq!(
            super::super::ocean_monument_direction_3d_value(super::super::OceanMonumentDirectionModel::East),
            5
        );
        assert_eq!(
            super::super::ocean_monument_opposite_direction(super::super::OceanMonumentDirectionModel::North),
            super::super::OceanMonumentDirectionModel::South
        );

        let building = super::super::ocean_monument_building(chunk_pos, 0, 3).unwrap();
        assert_eq!(building.orientation, super::super::HorizontalDirection::North);
        ...
        assert_eq!(
            super::super::ocean_monument_room_box(13, 2, 2, 2, super::super::HorizontalDirection::South),
            super::super::StructureBoundingBoxModel {
                min_x: 24,
                min_y: 0,
                min_z: 16,
        ...
        assert_eq!(
            super::super::ocean_monument_room_box(13, 2, 2, 2, super::super::HorizontalDirection::North),
            super::super::StructureBoundingBoxModel {
                min_x: 24,
                min_y: 0,
                min_z: -31,
