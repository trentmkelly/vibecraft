...
fn structure_piece_bounding_box_and_world_coordinates_match_vanilla_orientation() {
    assert_structure_make_bounding_box_matches_vanilla_orientation();
    assert_structure_orient_box_matches_vanilla_orientation();
    assert_structure_piece_world_coordinates_match_vanilla_orientation();
}

fn assert_structure_make_bounding_box_matches_vanilla_orientation() {
    assert_eq!(
...
fn assert_structure_orient_box_matches_vanilla_orientation() {
    let foot = BlockPos {
        x: 100,
        y: 40,
        z: 200,
    ...
    assert_eq!(
        super::super::structure_orient_box(
            foot,
            offset,
            5,
            6,
...
fn assert_structure_piece_world_coordinates_match_vanilla_orientation() {
