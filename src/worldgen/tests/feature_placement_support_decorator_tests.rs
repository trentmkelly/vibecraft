...
pub(super) fn assert_decorator_spring_and_monster_room_support() {
        ...
        assert_eq!(
            super::super::validate_tree_decorator(TreeDecoratorModel::CreakingHeart { probability: 0.0 }),
        ...
        assert_eq!(
            super::super::validate_tree_decorator(TreeDecoratorModel::AttachedToLogs { probability: 0.0 }),
        ...
        .is_empty());
        assert_eq!(
            super::super::beehive_decorator_placement(
                &[
                    BlockPos { x: 0, y: 64, z: 0 },
        ...
        assert!(super::super::beehive_decorator_placement(
            &[BlockPos { x: 0, y: 64, z: 0 }],
            &[],
            0.5,
            0.5,
        ...
        .is_none());
        assert_eq!(
            super::super::pale_moss_decorator_placement(
                &[
        ...
        assert!(
            super::super::pale_moss_decorator_placement(&[], &[], 1.0, 1.0, 1.0, 0.0, &[], &[], &[],)
                .is_empty()
        );
        assert_eq!(
        ...
        .unwrap()
        .is_empty());
        assert!(!super::super::tree_decorator_solid_render("minecraft:leaf_litter"));
        assert!(!super::super::tree_decorator_solid_render("minecraft:oak_leaves"));
        assert!(super::super::tree_decorator_solid_render("minecraft:grass_block"));
        ...
        assert!(alter_ground.contains(&super::super::TreeDecoratorPlacement {
            pos: BlockPos {
                x: -1,
                y: 66,
                z: -1
