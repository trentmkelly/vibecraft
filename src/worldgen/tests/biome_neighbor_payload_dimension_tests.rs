...
pub(super) fn assert_dimension_and_remaining_overworld_payloads() {
        ...
        assert_eq!(warped_forest.spawn_costs, super::super::WARPED_FOREST_SPAWN_COSTS);
        assert_eq!(
        ...
        assert_eq!(savanna_plateau.feature_steps, super::super::SAVANNA_FEATURE_STEPS);
        assert_eq!(
        ...
        assert!(super::super::biome_has_placed_feature(jungle, "minecraft:vines"));
        assert!(super::super::biome_has_placed_feature(
            jungle,
