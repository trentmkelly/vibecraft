...
#[test]
fn structure_processor_registry_orders_match_vanilla_templatesystem() {
    assert_eq!(
...
#[test]
fn structure_processor_ignore_rot_and_jigsaw_match_vanilla_templatesystem() {
    ...
    assert_eq!(
        jigsaw.jigsaw_replacement_output("minecraft:jigsaw", Some("minecraft:oak_planks"), false),
    ...
    assert_eq!(
        jigsaw.jigsaw_replacement_output("minecraft:jigsaw", Some("minecraft:oak_planks"), true),
        Some("minecraft:jigsaw")
    );
}

#[test]
fn structure_processor_gravity_lava_capped_and_rule_tests_match_vanilla_templatesystem() {
    ...
    assert!(super::super::structure_random_rule_test_matches(
        true, 0.25, 0.249
    ));
    assert!(!super::super::structure_random_rule_test_matches(
        true, 0.25, 0.25
...
fn rule_block_entity_modifiers_match_vanilla_template_rule_behavior() {
    assert_eq!(
        super::super::RuleBlockEntityModifierTypeModel::REGISTRY_ORDER
    ...
    assert_eq!(
        super::super::RuleBlockEntityModifierModel::Clear
            .apply(&mut random, Some(existing.clone())),
    ...
    assert_eq!(
        ...
        Some(&super::super::TemplateNbtValueModel::Long(
            6674089274190705457
        ))
    );
}
...
fn structure_template_manager_paths_and_cache_follow_vanilla_loader_rules() {
    ...
    let village =
        crate::registry::Identifier::parse("minecraft:village/plains/houses/plains_small_house_1")
    ...
    assert_eq!(
        ...
        Ok(
            "/world/generated/minecraft/structure/village/plains/houses/plains_small_house_1.nbt"
                .to_string()
        )
    );
    assert_eq!(
        ...
        Ok(
            "/world/generated/minecraft/structure/village/plains/houses/plains_small_house_1.snbt"
                .to_string()
        )
    );
    ...
    let dot_segment = crate::registry::Identifier::parse("minecraft:structure/./bad.nbt").unwrap();
    assert_eq!(
...
fn test_jigsaw_start_height() -> super::super::HeightProvider {
    super::super::HeightProvider::Constant {
        value: super::super::VerticalAnchor::Absolute(72),
    }
}

#[test]
fn jigsaw_structure_generation_point_matches_vanilla() {
    let structure = super::super::JigsawStructureModel::new_full(
        "minecraft:village/plains/town_centers",
        Some("minecraft:town_centers"),
        7,
        test_jigsaw_start_height(),
        true,
...
#[test]
fn jigsaw_structure_config_validation_matches_vanilla() {
    let start_height = test_jigsaw_start_height();
    assert_eq!(
...
fn structure_check_presence_and_lookup_branches_match_vanilla() {
    ...
    assert!(super::super::structure_start_can_satisfy_lookup(
        &start, false
    ));
    assert!(super::super::structure_start_can_satisfy_lookup(
        &start, true
...
fn terrain_adjustment_ids_and_bounding_boxes_match_vanilla() {
    ...
    for (adjustment, id) in ids {
        ...
        assert_eq!(
            super::super::TerrainAdjustmentModel::from_id(id),
            Some(adjustment)
        );
    }
    ...
    assert_eq!(
        super::super::structure_adjust_bounding_box(
            super::super::TerrainAdjustmentModel::None,
            bounding_box
        ),
        bounding_box
