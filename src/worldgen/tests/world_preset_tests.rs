...
#[test]
    fn flat_generator_defaults_and_presets_match_vanilla_bootstrap() {
        ...
        assert_eq!(super::super::flat_layers_total_height(FLAT_DEFAULT_LAYERS), 4);
        assert_eq!(
    ...
    fn flat_adjusted_generation_settings_filter_biome_features_like_vanilla() {
        ...
        let overworld =
            super::super::flat_generator_settings(super::super::flat_generator_preset("overworld").unwrap())
                .unwrap();
        let steps = super::super::flat_adjusted_generation_feature_steps(&overworld, plains.feature_steps);
        ...
        let void =
            super::super::flat_generator_settings(super::super::flat_generator_preset("the_void").unwrap())
                .unwrap();
        let void_steps = super::super::flat_adjusted_generation_feature_steps(&void, plains.feature_steps);
    ...
    fn world_preset_sources_match_vanilla_bootstrap_dimensions() {
        ...
        assert_eq!(super::super::world_preset_from_overworld_generator("custom"), None);
    ...
    fn world_preset_resolver_dispatches_vanilla_generator_codecs() {
        ...
        match normal.overworld.generator {
            super::super::ResolvedChunkGenerator::Noise {
                biome_source,
                biome_source_model,
                noise_settings,
            } => {
        ...
        match large.overworld.generator {
            super::super::ResolvedChunkGenerator::Noise { noise_settings, .. } => {
        ...
        match flat.overworld.generator {
            super::super::ResolvedChunkGenerator::Flat {
                biome_source_model,
                settings,
            } => {
                assert_eq!(
        ...
        match debug.overworld.generator {
            super::super::ResolvedChunkGenerator::Debug {
                biome,
                biome_source_model,
            } => {
    ...
    fn worldgen_preset_registry_resolves_vanilla_generators() {
        ...
        let single_biome =
            super::super::resolve_world_preset_from_registry(&registry, "minecraft:single_biome_surface")
                .unwrap()
                .overworld
                .generator;
        let super::super::ResolvedChunkGenerator::Noise {
        ...
        let flat = super::super::resolve_world_preset_from_registry(&registry, "minecraft:flat").unwrap();
        let super::super::ResolvedChunkGenerator::Flat { settings, .. } = flat.overworld.generator else {
    ...
    fn resolved_noise_generator_materializes_preview_terrain_chunks() {
        let chunk = super::super::generate_overworld_chunk_for_preset(ChunkPos { x: 0, z: 0 }, "normal")
