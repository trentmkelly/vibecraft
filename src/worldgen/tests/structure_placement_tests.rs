use super::*;
    ...
    fn structure_frequency_reducers_match_vanilla_methods() {
        assert_eq!(super::super::FrequencyReductionMethod::Default.id(), "default");
        assert_eq!(
    ...
    fn structure_locate_pos_uses_chunk_min_block_and_validated_offset() {
        assert_eq!(
            super::super::structure_locate_pos(ChunkPos { x: 21, z: -5 }, BlockPos { x: 8, y: 0, z: 8 })
                .unwrap(),
            BlockPos {
                x: 344,
                y: 0,
    ...
    fn structure_exclusion_zone_checks_square_chunk_range() {
        ...
        assert_eq!(super::super::validate_structure_exclusion_zone(zone), Ok(zone));
        assert_eq!(
            super::super::validate_structure_exclusion_zone(super::super::StructureExclusionZoneModel {
                other_set: "minecraft:villages",
                chunk_count: 17,
            })
            .unwrap_err(),
        ...
        assert!(super::super::structure_has_chunk_in_range(&other_chunks, 7, -1, 3));
    ...
    fn structure_manager_position_queries_use_union_and_piece_boxes() {
        ...
        assert!(super::super::structure_has_piece_at(inside_first_edge, &start));

        assert!(super::super::structure_start_contains_pos(
            inside_union_gap,
            &start
        ));
        assert!(!super::super::structure_has_piece_at(inside_union_gap, &start));
