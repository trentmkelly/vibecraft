...
- [ ] `ServerboundSetStructureBlockPacket` (0x3B): block pos, update type enum, mode enum, name, clamped offset/size bytes, mirror/rotation enums, metadata string capped at 128 chars, clamped integrity, seed VarLong, flags byte (ignore-entities=1, show-air=2, show-bounding-box=4, strict=8)
