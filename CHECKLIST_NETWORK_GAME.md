...
- [ ] `ClientboundSetHeldSlotPacket` (0x69): slot VarInt (renamed from older carried item packet)
...
- [ ] `ServerboundChangeDifficultyPacket` (0x04): difficulty enum byte
- [ ] `ServerboundClientCommandPacket` (0x0C): action enum VarInt (`PERFORM_RESPAWN`, `REQUEST_STATS`, `REQUEST_GAMERULE_VALUES`)
- [ ] `ServerboundClientTickEndPacket` (0x0D): empty payload
- [ ] `ServerboundLockDifficultyPacket` (0x1D): locked bool
...
- [ ] `ServerboundPaddleBoatPacket` (0x23): left-paddle, right-paddle booleans
- [ ] `ServerboundPlayerInputPacket` (0x2B): single-byte `Input.STREAM_CODEC` bitset for forward, backward, left, right, jump, shift, and sprint flags (26.1.2 format)
- [ ] `ServerboundPlayerLoadedPacket` (0x2C): empty payload
