...
- [y] Add a Mineflayer offline-mode version-lock test that verifies the configured Mineflayer/prismarine protocol version matches Minecraft Java Edition 26.1.2 before any black-box scenario runs.
